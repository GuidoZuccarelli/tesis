\part{Propuesta}
\label{part:propuesta}
En esta parte se presenta la propuesta de una estrategia posible para resolver los requerimientos de la aplicación planteada
con anterioridad.
Esta parte describirá de una forma genérica, todos los pasos que forman parte de dicha estrategia detallando los puntos a tener en cuenta 
para cualquier aplicación de este dominio que se requiera construir.
