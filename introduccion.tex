...
Los sistemas de recomendación basados en contenido \cite{Systems2011} utilizan un conjunto de informaciones y descripciones de los ítems previamente valorados por un usuario para poder construir un perfil del mismo de manera tal de poder determinar, cuales son sus intereses.
...
Los sistemas de recomendación de filtrado colaborativo \cite{Systems2011} utilizan la información histórica de cada usuario para intentar encontrar y generar grupos de usuarios con gustos similares. Para lograrlo se compara cada usuario con otro observando qué ítems evaluaron y qué puntajes fueron otorgados. 
...
Éste es el más simple de los sistemas de recomendación \cite{Poriya2014}, ya que como refiere su nombre, no 
...
indistintamente a cada uno de los usuarios habiendo previamente generado un ranking de popularidad.
...
Esto generó que los datos también puedan ser relacionados entre sí, de la misma manera que los documentos son interconectados formando una web de documentos, los datos interconectados forman una web de datos \cite{DiNoia2012} parelela.
...
La Web Semántica promete facilitar el desarrollo de la web social y la inteligencia colectiva \cite{Antoniou}, a través de mecanismos de clasificación, relación y descripción del contenido de la información publicada mejorando su interoperabilidad. Promete también mejorar la recolección, agregación e integración de datos específicos mediante el uso de agentes de búsqueda automáticos que aprovechan las ventajas.
...
y la funcionalidad del mismo actualmente inoperable.
...
obtenidos de sus reviews. Para construirlos en necesario obtener y convinar los puntajes de cada uno
...
de reviews que poseé cada ítem.
...
\item[Listas de ítems] Las listas de items son listas resultantes de búsquedas de ítems por nombre o por tipo. 
