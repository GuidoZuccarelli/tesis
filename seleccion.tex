...
Esta parte describe la implementación de todos los pasos de la estrategia propuesta de una forma genérica en la parte \ref{part:propuesta}
incluyendo todos los aspectos y elecciones que se tuvieron en cuenta al efectuarse cada implementación, los problemas encontrados 
en cada punto y los resultados obtenidos.
El objetivo de esta parte consiste en mostrar al lector, cómo aplicar los pasos de la estrategia al caso de estudio.
